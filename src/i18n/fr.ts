...
const fr: Translations = {
  ...
  shortcuts: {
    ...
    tabs: "Liste, horloge, carte",
    select: "Sélectionner la ville précédente ou suivante",
    open: "Afficher l’horloge de la ville sélectionnée",
    hour: "Déplacer la carte d’une heure",
    zone: "Déplacer la carte au fuseau suivant",
    theme: "Basculer clair et sombre",
    timeFormat: "Basculer 12 h et 24 h",
    close: "Fermer un panneau",
    help: "Afficher ces raccourcis",
    orKeys: "ou",
    keyUp: "Flèche haut",
    keyDown: "Flèche bas",
    keyLeft: "Flèche gauche",
    keyRight: "Flèche droite",
    keyShift: "Maj",
    keyEnter: "Entrée",
    keyEsc: "Échap",
    keySlash: "Barre oblique",
    keyQuestion: "Point d’interrogation",
  },
  settings: {
  ...
  cityPage: {
    ...
    ogEyebrow: "Heure locale à",
    ogOffsets: "{{standard}} · {{daylight}} à l’heure d’été",
    ogAlt: "Heure locale à {{place}} : {{offsets}}",
  },
  sun: {
    midnightSun: "Soleil de minuit",
    polarNight: "Nuit polaire",
