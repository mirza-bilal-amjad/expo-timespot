...
const hi: Translations = {
  ...
  shortcuts: {
    ...
    search: "कोई शहर खोजें",
    tabs: "सूची, घड़ी, नक्शा",
    select: "पिछला या अगला शहर चुनें",
    open: "चुने गए शहर की घड़ी दिखाएँ",
    hour: "नक्शे को एक घंटा खिसकाएँ",
    zone: "नक्शे को अगले समय क्षेत्र पर ले जाएँ",
    theme: "लाइट और डार्क बदलें",
    timeFormat: "12 और 24 घंटे का समय बदलें",
    close: "शीट बंद करें",
    help: "ये शॉर्टकट दिखाएँ",
    orKeys: "या",
    keyUp: "ऊपर तीर",
    keyDown: "नीचे तीर",
    keyLeft: "बायाँ तीर",
