const en = {
  ...
  shortcuts: {
    ...
    tabs: "List, clock, map",
    select: "Select the previous or next city",
    open: "Show the selected city's clock",
    hour: "Move the map by an hour",
    zone: "Move the map to the next time zone",
    theme: "Switch light and dark",
    timeFormat: "Switch 12- and 24-hour time",
    close: "Close a sheet",
