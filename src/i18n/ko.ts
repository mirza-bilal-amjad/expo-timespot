...
const ko: Translations = {
  ...
  list: {
    ...
    moveDown: "아래로 이동",
    remove: "삭제",
    renameTitle: "도시 이름 변경",
    renameCancel: "취소",
    save: "저장",
    useOriginalName: "“{{name}}” 사용",
    title: "세계 시간",
  ...
  settings: {
    ...
    timeData: "시간대 데이터",
    timeDataSystem: "시스템",
    timeDataBuiltIn: "내장 표 (2030년까지)",
  },
  notices: {
    citiesReset:
      "저장된 도시를 읽을 수 없어 TimeSpot이 새 목록으로 시작했습니다. 이전 데이터의 사본은 보관되어 있습니다.",
    prefsReset: "설정을 읽을 수 없어 기본값으로 재설정했습니다.",
    storageReset:
      "저장된 데이터 일부를 읽을 수 없어 TimeSpot이 처음부터 시작했습니다. 사본은 보관되어 있습니다.",
    storageRepaired: "저장된 항목 일부를 읽을 수 없어 삭제했습니다. 나머지는 모두 그대로입니다.",
    timeEngineDegraded:
      "이 기기의 시간대 지원이 제한적이어서 TimeSpot이 자체 시간대 표를 사용합니다. 시간은 2030년까지 정확합니다.",
    dismiss: "확인",
    dismissLabel: "이 메시지 닫기",
  },
  errors: {
    title: "문제가 발생했습니다",
    body: "TimeSpot이 스스로 복구할 수 없는 오류를 만났습니다. 다시 시도하면 대개 해결됩니다.",
    dataset:
      "도시 데이터를 불러올 수 없습니다. 다시 시도해 보세요. 계속 발생하면 TimeSpot을 다시 설치하세요.",
    retry: "다시 시도",
    reset: "저장된 데이터 초기화",
