...
const es: Translations = {
  ...
  shortcuts: {
    ...
    tabs: "Lista, reloj, mapa",
    select: "Seleccionar la ciudad anterior o siguiente",
    open: "Ver el reloj de la ciudad seleccionada",
    hour: "Mover el mapa una hora",
    zone: "Mover el mapa a la siguiente zona horaria",
    theme: "Cambiar entre claro y oscuro",
    timeFormat: "Cambiar entre 12 y 24 horas",
    close: "Cerrar una hoja",
    help: "Mostrar estos atajos",
    orKeys: "o",
    keyUp: "Flecha arriba",
    keyDown: "Flecha abajo",
    keyLeft: "Flecha izquierda",
    keyRight: "Flecha derecha",
    keyShift: "Mayús",
    keyEnter: "Intro",
    keyEsc: "Esc",
    keySlash: "Barra",
    keyQuestion: "Signo de interrogación",
  },
  settings: {
